...
/// difference there is expected, not a divergence. Integers carry their exact value as a decimal
/// string so the comparison is precise regardless of width.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub enum DiffValue {
    Field,
    Int { signed: bool, bits: u8, value: String },
    Bool(bool),
    Unit,
    Str(String),
    Array(Vec<DiffValue>),
